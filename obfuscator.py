...
def variable_renamer(given_string):
    ...
    special_cases = {
        "typedef", "unsigned", "void", "int", "char", "static", "const",
        "UefiMain", "EFI_STATUS", "EFI_HANDLE", "EFI_SYSTEM_TABLE",
        "Print", "gBS", "gST", "gRT", "EFI_SUCCESS", "EFIAPI", "IN", "OUT",
        "OPTIONAL", "CONST", "BOOLEAN", "TRUE", "FALSE", "UINT32", "UINT64",
        "UINTN", "EFI_EVENT", "EFI_GUID", "DEBUG", "ASSERT"
    }
